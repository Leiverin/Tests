...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final TruetimeLibraryAccessors laccForTruetimeLibraryAccessors = new TruetimeLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>rxjava</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public RxjavaLibraryAccessors getRxjava() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForRxjavaLibraryAccessors;
    }

    /**
     * Group of libraries at <b>truetime</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public TruetimeLibraryAccessors getTruetime() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForTruetimeLibraryAccessors;
    }
    ...
    public static class KotlinLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>kotlin.inject</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public KotlinInjectLibraryAccessors getInject() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForKotlinInjectLibraryAccessors;
        }
    ...
    public static class KotlinInjectLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>compiler</b> with <b>me.tatarka.inject:kotlin-inject-compiler-ksp</b> coordinates and
         * with version reference <b>kotlinInject</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getCompiler() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("kotlin.inject.compiler");
        }

        /**
         * Dependency provider for <b>runtime</b> with <b>me.tatarka.inject:kotlin-inject-runtime</b> coordinates and
         * with version reference <b>kotlinInject</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getRuntime() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("kotlin.inject.runtime");
        }
    ...
    public static class KotlinxCoroutinesLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>core</b> with <b>org.jetbrains.kotlinx:kotlinx-coroutines-android</b> coordinates and
    ...
    public static class RxjavaLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>android</b> with <b>io.reactivex.rxjava2:rxandroid</b> coordinates and
     ...
     */
    @Deprecated
    public static class TruetimeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public TruetimeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>truetime</b> with <b>com.github.instacart:truetime-android</b> coordinates and
         * with version reference <b>trueTime</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> asProvider() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("truetime");
        }

        /**
         * Dependency provider for <b>rx</b> with <b>com.github.instacart.truetime-android:library-extension-rx</b> coordinates and
         * with version reference <b>trueTimeRx</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidxLifecycle</b> with value <b>2.6.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>compileSdk</b> with value <b>33</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kotlinInject</b> with value <b>0.6.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>rxJava</b> with value <b>2.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>spotless</b> with value <b>6.15.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>trueTime</b> with value <b>4.0.0.alpha</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTrueTime() { return getVersion("trueTime"); }

        /**
         * Version alias <b>trueTimeRx</b> with value <b>3.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTrueTimeRx() { return getVersion("trueTimeRx"); }

        /**
         * Version alias <b>trueTimeVersionCode</b> with value <b>12</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTrueTimeVersionCode() { return getVersion("trueTimeVersionCode"); }

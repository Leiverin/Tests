        ...
        RewardedAd.load(
            ...
            object : RewardedAdLoadCallback() {
                override fun onAdFailedToLoad(error: LoadAdError) {
                    Log.e("LEVERIN-1","onAdFailedToLoad")
                ...
                override fun onAdLoaded(rewardedAd: RewardedAd) {
                    ...
                    rewardedAd.fullScreenContentCallback = object : FullScreenContentCallback() {
                        ...
                        override fun onAdDismissedFullScreenContent() {
                            Log.e("LEVERIN-1","onAdDismissedFullScreenContent")
                        ...
                        override fun onAdFailedToShowFullScreenContent(error: AdError) {
                            Log.e("LEVERIN-1","onAdFailedToShowFullScreenContent")
                        ...
                        override fun onAdImpression() {
                            Log.e("LEVERIN-1","onAdImpression")
                        ...
                        override fun onAdShowedFullScreenContent() {
                            Log.e("LEVERIN-1","onAdShowedFullScreenContent")
                    ...
                    activity.waitActivityResumed  {
                        ...
                        rewardedAd.show(activity) { _ ->
                            Log.e("LEVERIN-1","onUserEarnedReward")
                            onUserEarnedReward.invoke()
                        }
                    }
                }

...
//                AdmobOpen.show(appOpenAd, mCallback)
                AdmobOpen.show(
                    appOpenAd,
                    callback = object : TAdCallback {
                        override fun onAdImpression(adUnit: String, adType: AdType) {
                            ...
                            mCallback?.onAdImpression(adUnit, adType)
                        }
                        ...
                        override fun onAdClosed(adUnit: String, adType: AdType) {
                            ...
                            mCallback?.onAdClosed(adUnit, adType)
                        }
                        override fun onAdDismissedFullScreenContent(
                            ...
                            mCallback?.onAdDismissedFullScreenContent(adUnit, adType)
                        }
                    }
                )
            }
